...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { foods: @attendee.foods, name: @attendee.name } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { foods: @attendee.foods, name: @attendee.name } }
